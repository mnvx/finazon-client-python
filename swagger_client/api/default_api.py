...
class DefaultApi(object):
    ...
    def reference(self, **kwargs):  # noqa: E501
        """My Datasets  # noqa: E501

        Returns a list of datasets available for the workspace  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reference(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.reference_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.reference_with_http_info(**kwargs)  # noqa: E501
            return data

    def reference_with_http_info(self, **kwargs):  # noqa: E501
        """My Datasets  # noqa: E501

        Returns a list of datasets available for the workspace  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reference_with_http_info(async_req=True)
        >>> result = thread.get()
