...
class SymbolForex(object):
    ...
    def __init__(self, ticker=None):  # noqa: E501
        """SymbolForex - a model defined in Swagger"""  # noqa: E501
        self._ticker = None
    ...
    @property
    def ticker(self):
        """Gets the ticker of this SymbolForex.  # noqa: E501

        Instrument symbol (ticker)  # noqa: E501

        :return: The ticker of this SymbolForex.  # noqa: E501
        :rtype: str
        """
        return self._ticker
    ...
    def ticker(self, ticker):
        """Sets the ticker of this SymbolForex.

        Instrument symbol (ticker)  # noqa: E501

        :param ticker: The ticker of this SymbolForex.  # noqa: E501
        :type: str
        """
        if ticker is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SymbolForex, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SymbolForex):
            return False
