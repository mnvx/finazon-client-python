...
class ExchangesStocksResponseBody(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """ExchangesStocksResponseBody - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this ExchangesStocksResponseBody.  # noqa: E501


        :return: The data of this ExchangesStocksResponseBody.  # noqa: E501
        :rtype: list[ExchangeStocksItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ExchangesStocksResponseBody.


        :param data: The data of this ExchangesStocksResponseBody.  # noqa: E501
        :type: list[ExchangeStocksItem]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExchangesStocksResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExchangesStocksResponseBody):
            return False
