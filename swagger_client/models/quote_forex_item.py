...
class QuoteForexItem(object):
    ...
    def __init__(self, t=None, o=None, h=None, l=None, c=None):  # noqa: E501
        """QuoteForexItem - a model defined in Swagger"""  # noqa: E501
        self._t = None
        self._o = None
        self._h = None
        self._l = None
    ...
    @property
    def t(self):
        """Gets the t of this QuoteForexItem.  # noqa: E501

        Timestamp indicating when the trading interval opened  # noqa: E501

        :return: The t of this QuoteForexItem.  # noqa: E501
        :rtype: int
        """
        return self._t
    ...
    @t.setter
    def t(self, t):
        """Sets the t of this QuoteForexItem.

        Timestamp indicating when the trading interval opened  # noqa: E501

        :param t: The t of this QuoteForexItem.  # noqa: E501
        :type: int
        """
    ...
    @property
    def o(self):
        """Gets the o of this QuoteForexItem.  # noqa: E501

        Price at the opening of the trading interval  # noqa: E501

        :return: The o of this QuoteForexItem.  # noqa: E501
        :rtype: float
        """
        return self._o
    ...
    @o.setter
    def o(self, o):
        """Sets the o of this QuoteForexItem.

        Price at the opening of the trading interval  # noqa: E501

        :param o: The o of this QuoteForexItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def h(self):
        """Gets the h of this QuoteForexItem.  # noqa: E501

        Highest price reached during the trading interval  # noqa: E501

        :return: The h of this QuoteForexItem.  # noqa: E501
        :rtype: float
        """
        return self._h
    ...
    @h.setter
    def h(self, h):
        """Sets the h of this QuoteForexItem.

        Highest price reached during the trading interval  # noqa: E501

        :param h: The h of this QuoteForexItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def l(self):
        """Gets the l of this QuoteForexItem.  # noqa: E501

        Lowest price reached during the trading interval  # noqa: E501

        :return: The l of this QuoteForexItem.  # noqa: E501
        :rtype: float
        """
        return self._l
    ...
    @l.setter
    def l(self, l):
        """Sets the l of this QuoteForexItem.

        Lowest price reached during the trading interval  # noqa: E501

        :param l: The l of this QuoteForexItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def c(self):
        """Gets the c of this QuoteForexItem.  # noqa: E501

        Closing price at the end of the trading interval  # noqa: E501

        :return: The c of this QuoteForexItem.  # noqa: E501
        :rtype: float
        """
        return self._c
    ...
    @c.setter
    def c(self, c):
        """Sets the c of this QuoteForexItem.

        Closing price at the end of the trading interval  # noqa: E501

        :param c: The c of this QuoteForexItem.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuoteForexItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuoteForexItem):
            return False
