...
class BenzingaIPOResponseBody(object):
    ...
    def __init__(self, ipos=None):  # noqa: E501
        """BenzingaIPOResponseBody - a model defined in Swagger"""  # noqa: E501
        self._ipos = None
    ...
    @property
    def ipos(self):
        """Gets the ipos of this BenzingaIPOResponseBody.  # noqa: E501


        :return: The ipos of this BenzingaIPOResponseBody.  # noqa: E501
        :rtype: list[IPOItem]
        """
        return self._ipos
    ...
    @ipos.setter
    def ipos(self, ipos):
        """Sets the ipos of this BenzingaIPOResponseBody.


        :param ipos: The ipos of this BenzingaIPOResponseBody.  # noqa: E501
        :type: list[IPOItem]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BenzingaIPOResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BenzingaIPOResponseBody):
            return False
