...
class PublishersResponseBody(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """PublishersResponseBody - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this PublishersResponseBody.  # noqa: E501


        :return: The data of this PublishersResponseBody.  # noqa: E501
        :rtype: list[PublisherItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this PublishersResponseBody.


        :param data: The data of this PublishersResponseBody.  # noqa: E501
        :type: list[PublisherItem]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PublishersResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublishersResponseBody):
            return False
