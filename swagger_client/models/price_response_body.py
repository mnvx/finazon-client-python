...
class PriceResponseBody(object):
    ...
    def __init__(self, p=None):  # noqa: E501
        """PriceResponseBody - a model defined in Swagger"""  # noqa: E501
        self._p = None
    ...
    @property
    def p(self):
        """Gets the p of this PriceResponseBody.  # noqa: E501

        Price at which the trade occurred  # noqa: E501

        :return: The p of this PriceResponseBody.  # noqa: E501
        :rtype: float
        """
        return self._p
    ...
    @p.setter
    def p(self, p):
        """Sets the p of this PriceResponseBody.

        Price at which the trade occurred  # noqa: E501

        :param p: The p of this PriceResponseBody.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PriceResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PriceResponseBody):
            return False
