...
class BaseResponseBody(object):
    ...
    def __init__(self, status=None):  # noqa: E501
        """BaseResponseBody - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this BaseResponseBody.  # noqa: E501

        Response status. One of next values: ok, error  # noqa: E501

        :return: The status of this BaseResponseBody.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this BaseResponseBody.

        Response status. One of next values: ok, error  # noqa: E501

        :param status: The status of this BaseResponseBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BaseResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseResponseBody):
            return False
