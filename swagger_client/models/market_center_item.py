...
class MarketCenterItem(object):
    ...
    def __init__(self, code=None, name=None):  # noqa: E501
        """MarketCenterItem - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._name = None
    ...
    @property
    def code(self):
        """Gets the code of this MarketCenterItem.  # noqa: E501

        Market center code  # noqa: E501

        :return: The code of this MarketCenterItem.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this MarketCenterItem.

        Market center code  # noqa: E501

        :param code: The code of this MarketCenterItem.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    @property
    def name(self):
        """Gets the name of this MarketCenterItem.  # noqa: E501

        Market center name  # noqa: E501

        :return: The name of this MarketCenterItem.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MarketCenterItem.

        Market center name  # noqa: E501

        :param name: The name of this MarketCenterItem.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketCenterItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketCenterItem):
            return False
