...
class FilingFile(object):
    ...
    def __init__(self, name=None, size=None, type=None, url=None):  # noqa: E501
        """FilingFile - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._size = None
        self._type = None
        self._url = None
    ...
    @property
    def name(self):
        """Gets the name of this FilingFile.  # noqa: E501

        File name  # noqa: E501

        :return: The name of this FilingFile.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FilingFile.

        File name  # noqa: E501

        :param name: The name of this FilingFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this FilingFile.  # noqa: E501

        File size  # noqa: E501

        :return: The size of this FilingFile.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this FilingFile.

        File size  # noqa: E501

        :param size: The size of this FilingFile.  # noqa: E501
        :type: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this FilingFile.  # noqa: E501

        File type  # noqa: E501

        :return: The type of this FilingFile.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this FilingFile.

        File type  # noqa: E501

        :param type: The type of this FilingFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this FilingFile.  # noqa: E501

        File full url  # noqa: E501

        :return: The url of this FilingFile.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this FilingFile.

        File full url  # noqa: E501

        :param url: The url of this FilingFile.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FilingFile):
            return False
