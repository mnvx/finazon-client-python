...
class DatasetItem(object):
    ...
    @property
    def code(self):
        """Gets the code of this DatasetItem.  # noqa: E501

        Finazon code representing the dataset  # noqa: E501

        :return: The code of this DatasetItem.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this DatasetItem.

        Finazon code representing the dataset  # noqa: E501

        :param code: The code of this DatasetItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this DatasetItem.  # noqa: E501

        The official name of the dataset  # noqa: E501

        :return: The name of this DatasetItem.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DatasetItem.

        The official name of the dataset  # noqa: E501

        :param name: The name of this DatasetItem.  # noqa: E501
        :type: str
        """
