...
class DatasetsResponseBody(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """DatasetsResponseBody - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this DatasetsResponseBody.  # noqa: E501


        :return: The data of this DatasetsResponseBody.  # noqa: E501
        :rtype: list[MyDatasetItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this DatasetsResponseBody.


        :param data: The data of this DatasetsResponseBody.  # noqa: E501
        :type: list[MyDatasetItem]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DatasetsResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DatasetsResponseBody):
            return False
