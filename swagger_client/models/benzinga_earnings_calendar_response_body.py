...
class BenzingaEarningsCalendarResponseBody(object):
    ...
    """
    swagger_types = {
        'data': 'list[EarningsCalendarItem]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """BenzingaEarningsCalendarResponseBody - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this BenzingaEarningsCalendarResponseBody.  # noqa: E501


        :return: The data of this BenzingaEarningsCalendarResponseBody.  # noqa: E501
        :rtype: list[EarningsCalendarItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this BenzingaEarningsCalendarResponseBody.


        :param data: The data of this BenzingaEarningsCalendarResponseBody.  # noqa: E501
        :type: list[EarningsCalendarItem]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BenzingaEarningsCalendarResponseBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BenzingaEarningsCalendarResponseBody):
            return False
