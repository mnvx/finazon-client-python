...
class ExchangeCryptoItem(object):
    ...
    def __init__(self, code=None, name=None):  # noqa: E501
        """ExchangeCryptoItem - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._name = None
    ...
    @property
    def code(self):
        """Gets the code of this ExchangeCryptoItem.  # noqa: E501

        Finazon's identification code for the exchange  # noqa: E501

        :return: The code of this ExchangeCryptoItem.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this ExchangeCryptoItem.

        Finazon's identification code for the exchange  # noqa: E501

        :param code: The code of this ExchangeCryptoItem.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ExchangeCryptoItem.  # noqa: E501

        Official name of the cryptocurrency exchange  # noqa: E501

        :return: The name of this ExchangeCryptoItem.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ExchangeCryptoItem.

        Official name of the cryptocurrency exchange  # noqa: E501

        :param name: The name of this ExchangeCryptoItem.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExchangeCryptoItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExchangeCryptoItem):
            return False
