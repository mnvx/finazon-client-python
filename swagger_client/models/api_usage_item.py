...
class ApiUsageItem(object):
    ...
    swagger_types = {
        'api_calls': 'ApiCalls',
        'api_calls_price': 'ApiCalls',
        'api_calls_reference': 'ApiCalls',
        'api_calls_snapshots': 'ApiCalls',
        'api_calls_time_series': 'ApiCalls',
        'api_calls_trades': 'ApiCalls',
        'historical_api_calls': 'ApiCalls',
        'product': 'str'
    }

    attribute_map = {
        'api_calls': 'api_calls',
        'api_calls_price': 'api_calls_price',
        'api_calls_reference': 'api_calls_reference',
        'api_calls_snapshots': 'api_calls_snapshots',
        'api_calls_time_series': 'api_calls_time_series',
        'api_calls_trades': 'api_calls_trades',
        'historical_api_calls': 'historical_api_calls',
        'product': 'product'
    }

    def __init__(self, api_calls=None, api_calls_price=None, api_calls_reference=None, api_calls_snapshots=None, api_calls_time_series=None, api_calls_trades=None, historical_api_calls=None, product=None):  # noqa: E501
        """ApiUsageItem - a model defined in Swagger"""  # noqa: E501
        self._api_calls = None
        self._api_calls_price = None
        self._api_calls_reference = None
        self._api_calls_snapshots = None
        self._api_calls_time_series = None
        self._api_calls_trades = None
        self._historical_api_calls = None
        self._product = None
        self.discriminator = None
        if api_calls is not None:
            self.api_calls = api_calls
        if api_calls_price is not None:
            self.api_calls_price = api_calls_price
        if api_calls_reference is not None:
            self.api_calls_reference = api_calls_reference
        if api_calls_snapshots is not None:
            self.api_calls_snapshots = api_calls_snapshots
        if api_calls_time_series is not None:
            self.api_calls_time_series = api_calls_time_series
        if api_calls_trades is not None:
            self.api_calls_trades = api_calls_trades
        if historical_api_calls is not None:
            self.historical_api_calls = historical_api_calls
        self.product = product

    @property
    def api_calls(self):
        """Gets the api_calls of this ApiUsageItem.  # noqa: E501


        :return: The api_calls of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
    ...
    def api_calls(self, api_calls):
        """Sets the api_calls of this ApiUsageItem.


        :param api_calls: The api_calls of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """
    ...
    @property
    def api_calls_price(self):
        """Gets the api_calls_price of this ApiUsageItem.  # noqa: E501


        :return: The api_calls_price of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
        return self._api_calls_price

    @api_calls_price.setter
    def api_calls_price(self, api_calls_price):
        """Sets the api_calls_price of this ApiUsageItem.


        :param api_calls_price: The api_calls_price of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """

        self._api_calls_price = api_calls_price

    @property
    def api_calls_reference(self):
        """Gets the api_calls_reference of this ApiUsageItem.  # noqa: E501


        :return: The api_calls_reference of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
        return self._api_calls_reference

    @api_calls_reference.setter
    def api_calls_reference(self, api_calls_reference):
        """Sets the api_calls_reference of this ApiUsageItem.


        :param api_calls_reference: The api_calls_reference of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """

        self._api_calls_reference = api_calls_reference

    @property
    def api_calls_snapshots(self):
        """Gets the api_calls_snapshots of this ApiUsageItem.  # noqa: E501


        :return: The api_calls_snapshots of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
        return self._api_calls_snapshots

    @api_calls_snapshots.setter
    def api_calls_snapshots(self, api_calls_snapshots):
        """Sets the api_calls_snapshots of this ApiUsageItem.


        :param api_calls_snapshots: The api_calls_snapshots of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """

        self._api_calls_snapshots = api_calls_snapshots

    @property
    def api_calls_time_series(self):
        """Gets the api_calls_time_series of this ApiUsageItem.  # noqa: E501


        :return: The api_calls_time_series of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
        return self._api_calls_time_series

    @api_calls_time_series.setter
    def api_calls_time_series(self, api_calls_time_series):
        """Sets the api_calls_time_series of this ApiUsageItem.


        :param api_calls_time_series: The api_calls_time_series of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """

        self._api_calls_time_series = api_calls_time_series

    @property
    def api_calls_trades(self):
        """Gets the api_calls_trades of this ApiUsageItem.  # noqa: E501


        :return: The api_calls_trades of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
        return self._api_calls_trades

    @api_calls_trades.setter
    def api_calls_trades(self, api_calls_trades):
        """Sets the api_calls_trades of this ApiUsageItem.


        :param api_calls_trades: The api_calls_trades of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """

        self._api_calls_trades = api_calls_trades

    @property
    def historical_api_calls(self):
        """Gets the historical_api_calls of this ApiUsageItem.  # noqa: E501


        :return: The historical_api_calls of this ApiUsageItem.  # noqa: E501
        :rtype: ApiCalls
        """
        return self._historical_api_calls

    @historical_api_calls.setter
    def historical_api_calls(self, historical_api_calls):
        """Sets the historical_api_calls of this ApiUsageItem.


        :param historical_api_calls: The historical_api_calls of this ApiUsageItem.  # noqa: E501
        :type: ApiCalls
        """

        self._historical_api_calls = historical_api_calls

    @property
    def product(self):
        """Gets the product of this ApiUsageItem.  # noqa: E501

        Product  # noqa: E501

        :return: The product of this ApiUsageItem.  # noqa: E501
        :rtype: str
        """
    ...
    def product(self, product):
        """Sets the product of this ApiUsageItem.

        Product  # noqa: E501

        :param product: The product of this ApiUsageItem.  # noqa: E501
        :type: str
        """
        if product is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiUsageItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiUsageItem):
            return False
